<template>
    <div class="min-h-svh h-full flex items-center justify-center p-3">
        <div class="flex flex-col  w-full sm:w-2/3 md:w-4/5 xl:w-[800px]">
            ...
            <div class="rounded-2xl drop-shadow-2xl bg-white  p-4   ">
            <form class="w-full flex flex-col gap-6" @submit="submitHandler">
        <div class="flex flex-col gap-2">
            <div class="grid grid-cols-2 gap-4 md:grid-cols-2 grid-cols-1">
                <div>
